<?php
	...
	{
		$img_show= mysql_query("select * from clg_gallery where path='$_REQUEST[idimage]'") or die("Data is missing");
...
?>
	<div>
    <img src="gallery/<?php echo $img_next1[2];?>" class="img-resoponsive" height="500px">
    </div>
<?php
	}
...
?>
	<div>
    <img src="gallery/<?php echo $img_previous1[2];?>" class="img-resoponsive" height="500px">
    </div>
<?php
	}
...
?>
	<div>
    <img src="gallery/<?php echo $img_delete1[2];?>" class="img-resoponsive" height="500px">
    </div>
<?php
	}
?>