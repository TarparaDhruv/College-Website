...
<?php
	...
	{
		mysql_query("insert into clg_recruited values(0,'$_REQUEST[cp_name]','$_REQUEST[date_interview]','$_REQUEST[selectedstudents]') ") or die("ERROR OCCURED");
		mysql_query("delete from clg_placement where id='$_REQUEST[id]'") or die("entry is not deleted from clg_placement");
...
<body>
    ...
    <div class="container-fluid">
		<div class="row">
            ...
            <center><h1 style="font-variant:small-caps;">Recruited</h1></center>
            <div class="row">
            	<div class="col-md-offset-1 col-md-9" >
                	<form  action="" method="post"  enctype="multipart/form-data" name="form" >
                                        ...
                                        <input type="text" name="selectedstudents" class="form-control" required data-toggle="tooltip">
                                    	</div>
